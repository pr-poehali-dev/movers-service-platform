...
const services = [
  ...
  {
    icon: "Package",
    title: "Малогабаритные грузоперевозки на Ларгусе",
    desc: "Перевезём небольшие грузы, мебель, технику и коробки по городу и области. Вместительный Ларгус и опытный водитель.",
    price: "от 600 ₽",
    tag: "",
  },
];
