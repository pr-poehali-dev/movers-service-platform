...
const services = [
  {
    ...
    desc: "Перевезём всё — от хрупкой посуды до тяжёлой мебели. Без царапин и вмятин.",
    price: "от 2 500 ₽",
    tag: "Популярное",
  },
  {
    ...
    desc: "Перевозка офиса с минимальным простоем. Разберём, упакуем, соберём на новом месте.",
    price: "от 5 000 ₽",
    tag: null,
  },
  {
    ...
    desc: "Профессиональная упаковка любого объёма. Плёнка, коробки, пузырчатая упаковка — всё с собой.",
    price: "от 1 000 ₽",
    tag: null,
  },
  {
  ...
  },
  {
    icon: "Trash2",
    title: "Вывоз мусора",
    desc: "Вывезем строительный мусор, старую мебель и хлам. Грузим сами — вам ничего делать не нужно.",
    price: "от 1 500 ₽",
    tag: null,
  },
];
